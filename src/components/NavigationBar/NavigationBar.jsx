  ...
  return (
    <nav className='navigationBar'>
        ...
        <ul>
              ...
              <li><Link className={activeLink === 'resume' ? 'navIconText active' : 'navIconText'} to="/resume" onClick={hideSidebar}><FontAwesomeIcon icon={faDownload} /> Download Resume</Link></li>
            </ul>
        </div>
    </nav>
  )
